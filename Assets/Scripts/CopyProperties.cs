...
rotationX = " + rT.eulerAngles.x + @"f, rotationY = " + rT.eulerAngles.y + @"f, rotationZ = " + rT.eulerAngles.z + @"f " + (HasChildren ? ", childWidth = " + crT.sizeDelta.x + @"f, childHeight = " + crT.sizeDelta.y + @"f" : "");
        te.SelectAll();
        te.Copy();
        return te.text;
    }
